...
const policy=[
 ...
 {key:'geometry',title:'虚拟城市与台账边界',source:'city-data.js / METRO-05',text:'地图是12×8.4公里虚构城市，含不规则街区、河流湖区、建筑、道路、公园与设施。建筑高度、外观和模拟边界不是实测调查数据，不据此计算台账的土地面积、容积率或评分。手机双指可旋转、缩放和平移。'},
 {key:'product',title:'平台能力与建设进度',source:'ROADMAP / STUDIO-05',text:'已实现地图与地块档案、联合筛选、确定性演示评分、2至3宗比较、带来源检索问答、高清PNG及Markdown摘要、会话内评估记录。DeepSeek需要部署后端并配置密钥才能调用。真实GIS导入、账户权限、持久化、正式政策知识库、DOCX报告和正式复核尚未实现。'},
